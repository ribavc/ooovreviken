...
const GALLERY = [
  { src: "public/media/gallery-1.jpg", no: "Kaien", en: "The quay" },
  { src: "public/media/gallery-2.jpg", no: "Burger ved fjorden", en: "Burger by the fjord" },
  { src: "public/media/gallery-3.png", no: "Tapas og råvarer", en: "Tapas and produce" }
];
...
async function initMediaManifest() {
...
function loadPhoto(url) {
  ...
  return Promise.resolve(mediaFiles.has(filename));
}
